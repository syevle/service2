...
```
    <properties>
        <start-class>com.test.DockerApp</start-class>
    </properties>
```
...
```
	C:\00_ANA\JavaEE\WS\docker-java-app-example>docker build --tag=service2 .
...
```
	...
	service2   latest              a0c355a25236        About a minute ago   105MB
...
```
	...
	PID   USER     TIME  COMMAND
	    1 root      0:08 java -jar service2.jar
...
C:\00_ANA\JavaEE\WS\docker-java-app-example>docker container ls
CONTAINER ID        IMAGE                         COMMAND                  CREATED             STATUS              PORTS                  NAMES
159c3ee8ef39        service2            "java -jar docker-ja…"   16 minutes ago      Up 16 minutes       0.0.0.0:80->8080/tcp   adoring_jackson
